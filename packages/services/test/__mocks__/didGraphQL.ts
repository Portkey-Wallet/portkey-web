import { BaseGraphQL, CaHolderWithGuardian, IDIDGraphQL, IGraphQLClient } from '@portkey/graphql';
import type { GetCaHolderManagerInfoDto } from '@portkey/graphql/dist/esm/did/__generated__/types';
