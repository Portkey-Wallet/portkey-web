...
module.exports.caHolderNFTCollectionBalanceInfo = fs.readFileSync(path.join(__dirname, 'caHolderNFTCollectionBalanceInfo.gql'), 'utf8');
...
module.exports.loginGuardianChangeRecordInfo = fs.readFileSync(path.join(__dirname, 'loginGuardianChangeRecordInfo.gql'), 'utf8');
